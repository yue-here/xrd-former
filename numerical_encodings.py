# Modified from regression transformer - removed the get_device() function
# Added floating_tokens_to_float() function
...
class FloatEncoding(nn.Embedding):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # super().__init__( # Edit suggested by GPT-4
        ...
        # weights = weights.to(device="cpu") # in absence of GPU
